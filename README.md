# UDA-HFL
# User-Distribution-Aware Federated Learning for Efficient Communication and Fast Inference (PyTorch)
...
```
python3 federated-learning-mobile-edge-cloud-UDA-HFL.py --model=LB_Net --iid=1 --epochs=500 --num_users=50 --local_bs=50 --dataset=cifar --num_channel=3
```
...
* ```--local_bs:``` Batch size of local up
